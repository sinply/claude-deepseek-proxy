...
"%PS%" -NoProfile -Command "Get-CimInstance Win32_Process -Filter \"Name='powershell.exe'\" | Where-Object { $_.CommandLine -match 'proxy-watchdog.ps1' } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force; Write-Host \"stopped watchdog pid=$($_.ProcessId)\" }"
echo Done.
echo.
endlocal
